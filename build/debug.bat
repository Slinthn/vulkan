...
glslc -o terrain-v.spv ..\src\vulkan\glsl\terrain.vert
glslc -o terrain-f.spv ..\src\vulkan\glsl\terrain.frag

cl /nologo /I C:\VulkanSDK\1.3.250.1\Include /Z7 /Wall /wd5045 /DSLN_DEBUG /DSLN_VULKAN /DSLN_XAUDIO2 /DSLN_WIN64 ..\src\win64.c /link KERNEL32.LIB USER32.LIB ..\build\VULKAN-1.LIB XAUDIO2.LIB WS2_32.LIB
