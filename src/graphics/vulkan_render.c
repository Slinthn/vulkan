void vkr_begin(struct sln_vulkan_state state, float clear_color[4],
  ...
  render_pass_info.framebuffer = state.framebuffers[*new_image_index];
 ...
 * @param present_queue 
 */
void vkr_end(struct sln_vulkan_state state) {
...
void vkr_set_shader(struct sln_vulkan_state state,
...
void vkr_set_viewport(struct sln_vulkan_state state,
